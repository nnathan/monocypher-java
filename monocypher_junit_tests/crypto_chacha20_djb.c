...
int main(int argc, char **argv) {
  {
    ...
    ctr = crypto_chacha20_djb(cipher_text, plain_text, sizeof(plain_text), key,
                              nonce, ctr);
    printf("ctr: %llu\n", ctr);
...

  {
    ...
    ctr = crypto_chacha20_djb(cipher_text, plain_text, 64, key, nonce, ctr);
    printf("counter: %llu\n", ctr);
    ctr = crypto_chacha20_djb(cipher_text + 64, plain_text + 64, 1, key, nonce,
                              ctr);
    printf("counter: %llu\n", ctr);
...

  {
    ...
    ctr = crypto_chacha20_djb(cipher_text, NULL, sizeof(cipher_text), key,
                              nonce, ctr);
    printf("ctr: %llu\n", ctr);

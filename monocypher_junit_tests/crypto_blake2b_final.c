...
int main(int argc, char **argv) {
  ...
  crypto_blake2b_init(&ctx, sizeof(hash32));
  crypto_blake2b_update(&ctx, msg8, sizeof(msg8));
  crypto_blake2b_final(&ctx, hash32);

  char msg_hex_buf[17] = {0};
  to_hex_string(msg8, sizeof(msg8), msg_hex_buf);

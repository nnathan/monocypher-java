...
int main(int argc, char **argv) {
  {
    ...
    char expanded_hex_buf[128 + 1] = {0};
    char reduced_hex_buf[64 + 1] = {0};
    to_hex_string(expanded, sizeof(expanded), expanded_hex_buf);
    to_hex_string(reduced, sizeof(reduced), reduced_hex_buf);

...
public class MonocypherTest {
  ...
  @Test
  @Order(24)
  public void test_crypto_aead_write_x_inplace_with_ad_Pass()
      throws NoSuchFieldException, IllegalAccessException {
    byte[] key = new byte[32];
    ByteBuffer encrypted_message = ByteBuffer.allocateDirect(128);
  ...
  @Test
  @Order(25)
  public void test_crypto_aead_write_djb_inplace_with_ad_Pass()
      throws NoSuchFieldException, IllegalAccessException {
    byte[] key = new byte[32];
    ByteBuffer encrypted_message = ByteBuffer.allocateDirect(128);
  ...
  @Test
  @Order(26)
  public void test_crypto_aead_write_ietf_inplace_with_ad_Pass()
      throws NoSuchFieldException, IllegalAccessException {
    byte[] key = new byte[32];
    ByteBuffer encrypted_message = ByteBuffer.allocateDirect(128);
